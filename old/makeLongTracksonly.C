...
void makeLongTracksonly(  ) {
  ...
  TString outputlocation = "output/longtracksplots/";//where the output will be saved
  TString plotfilename = "longtracksplots.pdf";//name of file that will hold drawn plots
